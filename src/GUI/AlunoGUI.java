...
public class AlunoGUI extends javax.swing.JFrame {
     ...
     */
    public AlunoGUI() {
        setTitle("CADASTRO DE ALUNO - SADA V 1.1");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Telefone", 4, 1));
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(jfDDD2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jfFone2, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(jfDDD1)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jfFone1, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jtEmailFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtEmailFocusLost
        ValidaCampos vc = new ValidaCampos();
        if(vc.validar(100, jtEmail.getText()) == false){
            jtOper2.requestFocus();
        }
    ...
    private void selecionarLinhaTabela(JTable tabela) {
        if (jtTabela.getSelectedRow() != -1) {
            ...
            jtEmail.setText(listaAluno.get(tabela.getSelectedRow()).getEmail());
