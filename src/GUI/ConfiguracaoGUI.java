...
public class ConfiguracaoGUI extends javax.swing.JFrame {
    ...
    public ConfiguracaoGUI() {
        ...
        setTitle("CONFIGURAÇÃO - SADA V 1.1");
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        
        jtInfo.setEditable(false);
        jtInfo.setFont(new Font("Arial", Font.BOLD, 20));
        jtInfo.setText("Conectar com o banco de dados MySQL\n"
                + "Digite o usuário e senha do banco para\n"
                + "se conectar.");
        infor();
    }
