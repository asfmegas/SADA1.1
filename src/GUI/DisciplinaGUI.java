...
public class DisciplinaGUI extends javax.swing.JFrame {
    ...
    public DisciplinaGUI() {
        setTitle("DISCIPLINA - SADA V 1.1");
        initComponents();
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jtObjetivo, javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jcCursos, 0, 491, Short.MAX_VALUE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(jtNatureza, javax.swing.GroupLayout.PREFERRED_SIZE, 567, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(38, 38, 38)
                .addComponent(jbFechar, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 816, Short.MAX_VALUE)
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        ...
        if(vc.validarNumeros(1, 5, jtCarga.getText()) != 3){
            ...
            if(confirmarSalvarDados()){
                int resp = JOptionPane.showConfirmDialog(this, "Deseja excluir os dados da disciplina?\n"
                    + "Se a disciplina for excluida os movimentos relacionados a ela\ntambém serão apagados.","Confirmação",JOptionPane.YES_NO_OPTION);
        ...
        if(vc.validarNumeros(1, 5, jtCarga.getText()) != 3){
            ...
            if(confirmarSalvarDados()){
                ...
                try{
                    ...
                    JOptionPane.showConfirmDialog(null, "Erro ao listar tabela.an0\n"+e.getMessage());
                }
            }else{
    ...
    private void jtCargaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtCargaFocusGained
        jtCarga.selectAll();
    }//GEN-LAST:event_jtCargaFocusGained
    ...
    private void infor(){
        ...
        jbFechar.setToolTipText("Voltar");
    }
